...
fasta_path=${pdb_path}-sequences/
bash scripts/run_pmpnn_tied.sh $pdb_path $fasta_path 50 5
...
fasta_path=${pdb_path}-sequences/
bash scripts/run_pmpnn_tied.sh $pdb_path $fasta_path 50 6
...
fasta_path=${pdb_path}-sequences/
bash scripts/run_pmpnn_tied.sh $pdb_path $fasta_path 50 7
...
fasta_path=${pdb_path}-sequences/
bash scripts/run_pmpnn_tied.sh $pdb_path $fasta_path 100 3
...
fasta_path=${pdb_path}-sequences/
bash scripts/run_pmpnn_tied.sh $pdb_path $fasta_path 100 4
...
fasta_path=${pdb_path}-sequences/
bash scripts/run_pmpnn_tied.sh $pdb_path $fasta_path 100 2
